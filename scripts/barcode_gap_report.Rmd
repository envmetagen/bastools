...
message("steps: ",steps)
message("threshersteps: ",threshersteps)
message("plot.limit.taxon: ",plot.limit.taxon)
message("known_flags: ",known_flags)
message("TaxlevelTestall: ",TaxlevelTestall)
message("divergence: ",divergence)
...
message("limit.plot.to.taxon: ",limit.plot.to.taxon)
message("final.table.out: ",final.table.out)
message("tops: ",tops)
message("pidents.list: ",pidents.list)
