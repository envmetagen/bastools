...
## read settings
```{r, eval=TRUE,echo=F}
source("/home/tutorial/TOOLS/bastools/project_configs/MOCK_POST_REBIN_SCRIPT.config.R")
...
#changing sample_type and Primer_set to match functions
...
DT::datatable(taxaSteps2, rownames = TRUE, options = list(pageLength = 10, scrollX=T,scrollY=T,fixedColumns = list(leftColumns = 2, rightColumns = 0)),extensions = c('FixedColumns'))
