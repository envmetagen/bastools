...
## read settings
```{r, eval=TRUE,echo=F}
source("/home/tutorial/TOOLS/bastools/scripts/GUILHERME/example_POST_REBIN_SCRIPT.config.R")
...
DT::datatable(taxaSteps2, rownames = TRUE, options = list(pageLength = 10, scrollX=T,scrollY=T))
